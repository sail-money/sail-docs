...
{% hint style="warning" %}
The trusted core is deployed on six chains for testing and is under an ongoing external audit by [Octane Security](https://octane.security). It is not final — do not use it with funds you are not prepared to lose.
{% endhint %}
