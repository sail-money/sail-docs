...
* [Shared multi-tenant templates](shared-templates.md) — the recommended pattern: one deployment, per-account config, the opaque params blob, and the starter catalog.
