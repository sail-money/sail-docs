...
* **The owner key is never read by Sailor.** Mandate registration, configuration, and revocation require a deliberate EIP-712 signature from the owner/permission signer in the browser [signing station](dashboard.md) — Sailor only records the owner address and requests signatures.
